...
String j=(String)ss.getAttribute("abc");
	...
	if ((contentType != null) && (contentType.indexOf("multipart/form-data") >= 0)) {
		...
		Connection con =DriverManager.getConnection("jdbc:mysql://localhost/jaspreet","root","root");
		String sql1="update userreg set picture=(?) where uname=?";
		PreparedStatement s1=con.prepareStatement(sql1);
		s1.setString(1,saveFile);
		s1.setString(2,j);
		s1.execute();
